...
<html lang="en">
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-item nav-link active" href="adminlan.php">Home <span class="sr-only">(current)</span></a>
  ...
  <div class="jumbotron">
    ...
    <hr class="my-4">
    <p>Jika Sudah, lihat Perkembangan Task mu kemarin dan hari ini.</p>
    <p class="lead">
      <a class="btn btn-primary btn-lg" href="#" role="button">Check</a>
    </p>
  </div>
